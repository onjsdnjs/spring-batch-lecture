...
import io.anymobi.batch.listener.job.DataSendChildJobListener;
import io.anymobi.batch.tasklet.send.SendDataPostTasklet;
import io.anymobi.batch.tasklet.send.SendDataPreTasklet;
import io.anymobi.batch.tasklet.send.SendDataTasklet;
...
public class SendChildJobConfiguration2 {
    ...
    private final Step apiStep1;
    private final Step apiStep2;
    private final Step apiStep3;
    private final SharedObject sharedObject;

    @Bean
    public Step jobStep(JobLauncher jobLauncher) throws Exception {
